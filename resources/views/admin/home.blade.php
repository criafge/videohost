                ...
                <div class="card bg-dark text-light shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex gap-3">
                                <a href="{{ route('change-status', [$item->id, 2]) }}"
                                    class="btn btn-outline-light">Нарушение
                                    👺</a>
                                <a href="{{ route('change-status', [$item->id, 3]) }}" class="btn btn-outline-light">Теневой
                                    бан👹</a>
                                <a href="{{ route('change-status', [$item->id, 4]) }}" class="btn btn-outline-light">Бан
                                    💀</a>
                                <a href="{{ route('change-status', [$item->id, 1]) }}" class="btn btn-outline-danger">Снять
                                    ограничения 😜</a>
                            </div>
